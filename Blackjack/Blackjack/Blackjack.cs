...
namespace Blackjack
{
    class Blackjack
    {
        static string[] _playerCards = new string[11];
        ...
        static void Start()
        {
            ...
            do
            {
                Console.WriteLine("Welcome to Blackjack! You were dealt " + _playerCards[0] + " and " +
        ...
        {
            count += 1;
            _playerCards[count] = Deal();
            Console.WriteLine("\nYou were dealt a(n) " + _playerCards[count] + ".\nYour new total is " + total + ".");
            if (total.Equals(21))
            {
